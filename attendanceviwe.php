...
$result=attendanceviwe();
$datetime1 = new DateTime($checkin);
$datetime2 = new DateTime($checkout);
$interval = $datetime1->diff($datetime2);
$timev=$interval->format('%H:%I:%S');

  $va1=substr($timev,0,2); 
...
<th>
            <?php echo $checkin=$row['checkin']?>
</th>
<th>
            <?php echo $checkout=$row['checkout']?>
</th>

<th>

<?php echo $va1=substr($timev,0,2); ?>
</th>
...
<th>
  <a href="declare.php?id=<?php echo $row['id']?>">Report</a>
</th>
</tr>
<?php
$sno++;
