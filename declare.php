  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
            <div class="col-sm-12">
			<form action="declareupdate.php" method="post">
...
<p><textarea  style="float:right;width:75%;height:150px" class="form-control" id="comment" type="text" name="comment" ></textarea></p>
